...
class CashFrame extends JFrame
{
	...
	class calculateListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			CashSuper cs = CashFactory.createCashAccept(cashButton.getSelectedItem().toString());
			double totalPrice = 0;
			totalPrice = cs.acceptCash(Double.valueOf(priceField.getText()) * Double.valueOf(amountField.getText()));
